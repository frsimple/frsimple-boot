package org.simple.tool.satoken;
...
public class MySaTokenListener implements SaTokenListener {
    ...
    public void doLogin(String loginType, Object loginId, String tokenValue, SaLoginModel saLoginModel) {
        try {
            ...
            Class<?> targetCls = org.simple.controller.AuthController.class;
    ...
    private void saveLogData(Object loginId, Method targetMethod, long startTime) {
        ...
        Logs logsData = logsService.getLogData(summary, loginId.toString(), duration, request);
