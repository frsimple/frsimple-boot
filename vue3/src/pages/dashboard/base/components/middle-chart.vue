<template>
  <t-row :gutter="10" class="row-container">
    <t-col :xs="12" :xl="9">
      <t-card title="统计数据" :subtitle="`(万元)${currentMonth}`" :bordered="false" class="dashboard-chart-card">
        <template #option>
    ...
    <t-col :xs="12" :xl="3">
      <t-card title="销售渠道" :subtitle="currentMonth" :bordered="false" class="dashboard-chart-card">
        <div
          id="countContainer"
